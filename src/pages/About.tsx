...
export const About = () => {
  return (
    <div className="pt-32 pb-20">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-32">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
          <motion.div {...fadeInUp}>
            ...
            <h1 className="text-5xl md:text-7xl font-bold font-display text-white mb-8 leading-[0.9]">
              Ми Створюємо <br />
            ...
            <div className="grid grid-cols-2 gap-12">
              <div>
                <div className="text-4xl font-bold font-display text-white mb-2">10+</div>
                <div className="text-[10px] font-bold uppercase tracking-widest text-gray-500">Років Досвіду</div>
              </div>
              <div>
                <div className="text-4xl font-bold font-display text-white mb-2">5000+</div>
      ...
      {/* Values Section */}
      <section className="py-32 bg-white/[0.01] border-y border-white/5 mb-32">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div {...fadeInUp} className="text-center mb-20">
            <span className="text-blue-500 text-xs font-bold tracking-[0.2em] uppercase mb-4 block">Наші Цінності</span>
            <h2 className="text-4xl md:text-5xl font-bold font-display text-white">Чому Обирають Нас</h2>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            {[
              ...
              <div key={i} className="group p-10 bg-white/[0.02] border border-white/5 hover:border-blue-500/30 transition-all">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <motion.div 
          ...
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
          className="bg-blue-600 p-12 md:p-20 text-center relative overflow-hidden"
        >
          <div className="absolute top-0 left-0 w-full h-full bg-[url('https://www.transparenttextures.com/patterns/carbon-fibre.png')] opacity-10 pointer-events-none" />
          <h2 className="text-4xl md:text-6xl font-bold font-display text-white mb-8 relative z-10">Готові До Трансформації?</h2>
          ...
          <Link 
            to="/contact"
            className="inline-flex items-center gap-4 px-12 py-6 bg-white text-black font-bold text-xs tracking-[0.3em] uppercase hover:bg-gray-200 transition-all relative z-10"
          >
