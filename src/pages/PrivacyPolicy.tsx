...
export const PrivacyPolicy = () => {
  return (
    <div className="pt-32 pb-20 bg-[#050505] overflow-hidden">
      <SEO
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        ...
        <div className="relative z-10 grid grid-cols-1 lg:grid-cols-[0.8fr_1.2fr] gap-8 lg:gap-10">
          <aside className="lg:sticky lg:top-28 h-fit border border-white/10 bg-white/[0.02] p-7 md:p-8">
            <span className="inline-flex items-center gap-2 text-[10px] uppercase tracking-[0.22em] font-bold text-blue-300 mb-5">
              <ShieldCheck className="w-4 h-4" />
              Privacy Notice
            </span>
            <h1 className="text-4xl md:text-5xl font-bold font-display text-white leading-[1.02] mb-6">Політика конфіденційності</h1>

            <div className="border border-blue-500/30 bg-blue-500/10 px-4 py-3 text-sm text-blue-100 mb-6 inline-flex items-center gap-2">
          ...
          <div className="space-y-4">
            {policySections.map((section, index) => (
              <article key={index} className="border border-white/10 bg-white/[0.02] p-6 md:p-7 hover:border-blue-500/40 hover:bg-blue-950/10 transition-all">
                <h2 className="text-xl md:text-2xl font-bold font-display text-white mb-3">{section.title}</h2>
                <p className="text-gray-300 leading-relaxed">{section.body}</p>
              </article>
            ))}

            <article className="border border-blue-500/35 bg-blue-950/10 p-6 md:p-7">
              <h2 className="text-xl md:text-2xl font-bold font-display text-white mb-4">6. Контакти</h2>
