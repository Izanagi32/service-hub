    ...
    <div className="pt-32 pb-20">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <motion.div {...fadeInUp} className="text-center mb-20">
          ...
          <h1 className="text-5xl md:text-7xl font-bold font-display text-white mb-6">Майстри Своєї Справи</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12">
          {teamMembers.map((member, index) => (
            <motion.div
              ...
              className="group relative p-4 rounded-2xl transition-all duration-500 hover:bg-white/[0.02] hover:shadow-[0_20px_50px_-20px_rgba(37,99,235,0.15)]"
            >
              ...
              <div className="text-center">
                <h3 className="text-xl font-bold text-white font-display mb-1 tracking-wide">{member.name}</h3>
